...
62 rank comparisons are enumerated; 25 of them are selections between candidate configurations. **13 of those 25 do not clear the floor their own statistic and block license, 9 clear it, and 3 cannot be judged at all** because no floor has been measured for the statistic, block, reading step and arm they sit on. 5 rows are exempt with the reason stated, 19 of the 62 are unjudgeable for want of a floor, and 40 carry an explicit statistic-, block- or kind-mismatch note.
